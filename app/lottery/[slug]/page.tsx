...
export default async function LotterySchemePage({ params }: PageProps) {
  ...
  const breadcrumbs = [
    ...
    { name: lottery.name, url: `${SITE_URL}/lottery/${lottery.slug}` },
  ];
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 lg:p-10 border border-[#E2E7E3] shadow-sm space-y-6">
        ...
        <div className="flex flex-wrap items-center gap-3 pt-2">
          ...
          >
            ...
            <span>All Historical Results</span>
          </Link>
        </div>
      </div>
      ...
      {latestDraw && (
        <div className="space-y-4">
          ...
          <div className="pt-2">
            ...
            >
              <span>View full gazette result page for {formatDateOnly(latestDraw.drawDate)} →</span>
            </Link>
          </div>
        </div>
      )}
